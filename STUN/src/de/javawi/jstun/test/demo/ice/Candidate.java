...
public class Candidate implements Comparable
{
	...
	public Candidate(Address address, short componentId) throws SocketException,
	...
	public Candidate(Address address,
			CandidateType type,
			short componentId,
			Candidate base) throws SocketException,
			UnknownHostException,
			UtilityException
	{
		this.socket = new DatagramSocket(0, address.getInetAddress());
	...
	public boolean equals(Object o)
	{
		if (o == null)
			return false;
		if ((((Candidate) o).socket.equals(socket)) && (((Candidate) o).base
				.equals(base)))
			return true;
		return false;
	}
