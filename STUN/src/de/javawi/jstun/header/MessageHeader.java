...
public class MessageHeader implements MessageHeaderInterface
{
	...
	{
		System.arraycopy(Utility.integerToTwoBytes((int) (Math.random() * 65536)),
				0,
				id,
				0,
				2);
	...
	public byte[] getBytes() throws UtilityException
	{
		...
		System.arraycopy(Utility.integerToTwoBytes(typeToInteger(type)),
				0,
				result,
				0,
				2);
		System.arraycopy(Utility.integerToTwoBytes(length - 20),
				0,
				result,
				2,
				2);
		...
		{
			MessageAttribute attri = ma.get(it.next());
			System.arraycopy(attri.getBytes(),
					0,
					result,
					offset,
					attri.getLength());
